...
loc_png <- paste0(.z$PX, "C02P01", "_Drinks_Bar", ".png")
ggsave(loc_png, plot = C02P01)
```
...
loc_png <- paste0(.z$PX, "C02P02", "_Drinks_Pie", ".png")
ggsave(loc_png, plot = C02P02)
```
...
loc_png <- paste0(.z$PX, "C02P03", "_Normal_Histogram", ".png")
ggsave(loc_png, plot = C02P03)
```
...
loc_png <- paste0(.z$PX, "C02P04", "_Random_Dot", ".png")
ggsave(loc_png, plot = C02P04)
```
...
loc_png <- paste0(.z$PX, "C02P05", "_ScatterPlot", ".png")
ggsave(loc_png, plot = C02P05)
```
