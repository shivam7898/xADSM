...
- This chapter covers 
  - Transpose, Attributes, Total Row, Cut, Clipboard, Replace NA
  - Bar Chart, Pie Chart, Histogram, CrossTab, Scatter Plot, Trendline, ThemeGG
...
## Summarizing Data for Two Variables Using Tables {.tabset .tabset-fade}
...
- Simpson's Paradox
  ...
  - Cause
    ...
    - Because Judge Luckett tried a much higher percentage of his cases in 'Municipal', the aggregated data favored Judge Kendall i.e. 118/150 for Luckett vs. 25/125 for Kendall.
...
## Summarizing Data for Two Variables {.tabset .tabset-fade}
