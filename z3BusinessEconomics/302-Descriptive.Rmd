...
- Simpson's Paradox
  ...
  - Ex: Table \@ref(tab:302DK-Judges) shows the count of judgements that were 'upheld' or 'reversed' on appeal for two judges 
...
```{r '302CK-Judges-A', ref.label=c('302CK-Judges'), eval=FALSE}
#
```
...
```{r '302NA-Trendline', include=FALSE}
bb <- be0214 
...
```{r '302NA-Trendline-A', ref.label=c('302NA-Trendline'), eval=FALSE}
#
```
