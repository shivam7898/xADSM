...
bb_testT <- t.test(value ~ key, data = bb, alternative = bb_ha)
bb_testT
#
...
Let ${\mu}_d$ = the mean of the difference in values for the population of workers.
...
\textcolor{pink}{Test Statistic with $(n-1)$ degrees of freedom :} Refer \@ref(eq:t-pair) like \@ref(eq:test-statistic-no-sigma) 
