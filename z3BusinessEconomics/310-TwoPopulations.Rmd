...
The \textcolor{pink}{Shapiro-Wilk test} is a test of normality. It tests the null hypothesis that a sample came from a normally distributed population. \textcolor{pink}{$P_{\text{shapiro}} > ({\alpha} = 0.05) \to \text{Data is Normal}$}
```
