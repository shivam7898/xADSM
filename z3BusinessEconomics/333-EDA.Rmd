...
title_hh <- "corrplot::corrplot (with Clusters) vs. psych::corPlot"
loc_png <- paste0(.z$PX, "C33P31","_Churn_corrplot_corPlot", ".png")
#
if(!file.exists(loc_png)) {
...
```{r 'C33P31', echo=FALSE, fig.cap="corrplot::corrplot vs. psych::corPlot()", out.width='100%'}
knitr::include_graphics(paste0(.z$PX, "C33P31","_Churn_corrplot_corPlot", ".png"))
```
