...
knitr::include_graphics(paste0(.z$PX, "C33P06","_Churn_pStack_Multi", ".png"))  #iiii
```
...
f_rmExist(aa, bb, ii, jj, kk, ll, c33churn, C33P01, C33P02, C33P03, caption_hh, hh, legend_hh, loc_png, subt_hh, title_hh, x_hh, xxB16Cars, xxB18Churn, y_hh, c_xyg, cap_hh, ctab, names_hh, r_xyg, xyg, C33P04)
```
