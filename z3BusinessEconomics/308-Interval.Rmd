...
The confidence level expressed as a decimal value is the \textcolor{pink}{confidence coefficient ($1-{\alpha}$)}. i.e. 0.95 is the confidence coefficient for a 95% confidence level.
```
