...
- This chapter covers 
  - [Continuos Probability](#continuous-prob-c06 "c06")
...
- Refer equation \@ref(eq:distribution-normal)
  - Normal distribution is also known as Gaussian or Gauss or Laplace–Gauss distribution
  - It is symmetrical
...
f_rmExist(aa, bb, ii, jj, kk, ll, C06P01, density_hh, density_hh_tbl, hh, ii_mean, ii_median, len_hh, mean_hh, median_hh, q05_hh, q95_hh, sd_hh, sig1l_hh, sig1r_hh, sig2l_hh, sig2r_hh, sig3l_hh, sig3r_hh, xbreaks_hh, xlabels_hh, xpoints_hh, xxNormal)
```

```{r 'C06-Validation', include=TRUE, cache=FALSE}
