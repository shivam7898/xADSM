...
For the ${\sigma}$ unknown case, the sampling distribution of the test statistic follows the t distribution with $(n − 1)$ degrees of freedom. Refer equation \@ref(eq:test-statistic-nsd)

\begin{equation}
  t = \frac{\overline{x} - \mu_0}{s/\sqrt{n}}
  (\#eq:test-statistic-nsd)
\end{equation}
...
- Ex: Heathrow Airport, testing for mean rating 7 i.e. ${\mu}_0 = 7$
  ...
  - ${\alpha} = 0.05$
  - Refer equation \@ref(eq:test-statistic-nsd), $t = \frac{\overline{x} - \mu_0}{s/\sqrt{n}} = \frac{7.25 - 7}{1.052/\sqrt{60}} = 1.84$
  - $\text{DOF} = n-1 = 60 -1 = 59$
...
- Ex: Holiday Toys, testing for sale of 40 units, i.e. ${\mu}_0 = 40$
  ...
  - ${\alpha} = 0.05$
  - Refer equation \@ref(eq:test-statistic-nsd), $t = \frac{\overline{x} - \mu_0}{s/\sqrt{n}} = \frac{37.4 - 40}{11.79/\sqrt{25}} = -1.10$
  - $\text{DOF} = n-1 = 25 -1 = 24$
