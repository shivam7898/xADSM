...
- Indentations is important. Use 4 Spaces
  - Additional advantage is Python and R Codes would look different
...
- Python
  ...
  - scikit-learn canot handle missing values at all
...
if(False):
    def rstr(aa): return aa.shape, aa.apply(lambda x: [x.unique()]) #Not Woring as expected
    print(rstr(pp))
