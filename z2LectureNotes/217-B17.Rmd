...
```{r 'B-PlotHistInvSqare', eval=FALSE}
...
#
title_hh <- "QQ Plot of Weight (Excluding 1 Outlier) Modified Y-Axis"
caption_hh <- "B17P04"
#
...
knitr::include_graphics(paste0(.z$PX, "B17P04","_Cars_Weight_QQ", ".png")) #iiii
```
