...
```{r 'B27-Data', include=FALSE, eval=FALSE}
#dim(xxB26Hmod)
...
```{r 'B27-Train', include=FALSE, eval=FALSE}
set.seed(3)
...
```{r 'B27-NA', include=FALSE, eval=FALSE}
train_ii <- na.omit(train_bb)
```


```{r 'B27-Model', include=FALSE, eval=FALSE}
...
```{r 'B27-NOrmal', include=FALSE, eval=FALSE}
...
```{r 'B27-MultiColl', include=FALSE, eval=FALSE}
vif(model2)
```
...
```{r 'B27-Transform', include=FALSE, eval=FALSE}
...
```{r 'B27-IsNormal', include=FALSE, eval=FALSE}
shapiro.test(model4$residuals)
```



```{r 'B27-VIF', include=FALSE, eval=FALSE}
vif(model4)
```
...
```{r 'B27-Glance', include=FALSE, eval=FALSE}
