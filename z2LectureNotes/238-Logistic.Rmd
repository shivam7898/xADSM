...
# #Not Plotted
tuneRF(x = zBalanced[, -1], y = zBalanced$churn, stepFactor = 2, plot = TRUE, 
...
loc_png <- paste0(.z$PX, "B38P01", "-Churn-Train-ROC", ".png")
```
...
if(FALSE){# #Absolute Paths
  knitr::include_graphics(paste0(.z$PX, "B38P01", "-Churn-Train-ROC", ".png"))
  knitr::include_graphics(paste0(here::here(), "/images/", "B38P01", "-Churn-Train-ROC", ".png"))
  knitr::include_graphics(here::here("images", "B38P01-Churn-Train-ROC.png"))  
}
# #~ == User Documents
# #. == Project Root Path (Use with Slash "/" )
if(FALSE) knitr::include_graphics("./images/B38P01-Churn-Train-ROC.png") #Works
knitr::include_graphics(paste0(".", "/images/", "B38P01", "-Churn-Train-ROC", ".png"))
```
...
f_rmExist(aa, bb, ii, jj, kk, ll, auc_hh, both_churn, cap_hh, cmat, cmat_10_forest, 
