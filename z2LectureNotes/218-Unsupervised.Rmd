...
```{r 'B18P03', echo=FALSE, out.width='100%', fig.cap="Churn: All Histograms"}
...
```{r 'B18P04', echo=FALSE, out.width='100%', fig.cap="Churn: All QQ Plots"}
...
```{r 'B18P050607', echo=FALSE, out.width='33%', ref.label=c('B18P05', 'B18P06', 'B18P07'), fig.cap="Churn: BoxPlots of Calls, Minutes, & Charges"}
#
```
...
```{r 'B18P080910', echo=FALSE, out.width='33%', ref.label=c('B18P08', 'B18P09', 'B18P10'), fig.cap="Churn: BoxPlots of International Calls, Minutes, & Charges"}
#
```
...
```{r 'B18P111213', echo=FALSE, out.width='33%', ref.label=c('B18P11', 'B18P12', 'B18P13'), fig.cap="Churn: BoxPlots of Reamining Three"}
#
```
...
B18 <- hh %>% { ggplot(data = ., mapping = aes(x = Values)) + 
    ...
    theme(plot.title.position = "panel", 
          strip.text.x = element_text(size = 10, colour = "white")) +
    facet_wrap(~Key, nrow = 3, scales = 'free') +
    labs(x = "z", y = NULL, caption = cap_hh, subtitle = NULL, title = ttl_hh)
}
assign(cap_hh, B18)
rm(B18)
```
...
```{r 'B18P14', echo=FALSE, out.width='100%', fig.cap="Churn: All Histograms (Scaled)"}
...
```{r 'B18P15', echo=FALSE, out.width='100%', fig.cap="Churn: All QQ Plots (Scaled)"}
...
```{r 'B18P16', echo=FALSE, out.width='100%', fig.cap="Churn: All Box Plots (Scaled)"}
...
B18 <- hh %>% { ggplot(data = ., mapping = aes(x = Values, fill = Group)) + 
    ...
    labs(x = "x", y = NULL, fill = NULL, caption = cap_hh, subtitle = NULL, title = ttl_hh)
}
assign(cap_hh, B18)
rm(B18)
```
...
```{r 'B18P17', echo=FALSE, out.width='100%', fig.cap="Churn: All Histograms"}
