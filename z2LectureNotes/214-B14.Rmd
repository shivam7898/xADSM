...
- Compare with ${\alpha} = 0.05$
  ...
  - We cannot claim that the average sales is 'at least' 8-million
...
- If yes, perform the test again using an appropriate hypothesis test.
...
- Compare with ${\alpha} = 0.05$
  ...
  - We cannot claim that the average sales is 'at least' 8-million (same as earlier)
...
- Prudy Perkins, the Chief Marketing Office (CMO) informed the board that they win at least 50% of the sales leads that they receive. Use an appropriate hypothesis testing procedure to check whether the proportion of leads won by WSES is more than 50%.

- It is a Test of proportion
