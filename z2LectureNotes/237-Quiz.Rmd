...
jjn <- c(cmat$overall[["Accuracy"]], sum(cmat$table), 
        ...
        cmat$table["No", "Yes"], cmat$table["No", "No"], round(cmat$byClass, 4))
#
if(TRUE) tibble(Names = hh_names, GLM_Train = iio, GLM_Test = iin, LDA_Train = iio, LDA_Test = iin)
```
...
knitr::include_graphics(paste0(.z$PX, "B37P02", "-Insurance-Test-ROC", ".png"))
```
...
f_rmExist(aa, bb, ii, jj, kk, ll, auc_hh, B37P01, B37P02, both_insurance, cap_hh, cmat, 
          ...
          res_3_lda_test, ttl_hh, xfw, xxB37Insurance, zBalanced, zInsurance, zTest)
```
