...
f_getDef("Approach-p-value-Steps") #dddd
```
...
1.  \textcolor{pink}{Question:} If we get a z-value of 1.99 (Right Tail), would we reject the null at ${\alpha} = 0.05$
    - For z = 1.99 & Right Tail, p-value = `r z06` 
...
f_rmExist(aa, bb, ee, hh, ii, jj, kk, ll, mm, nn, oo, rr, vv, xx, yy, zz, z01, z02, z03, z04, z05, z06)
```
