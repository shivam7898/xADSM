...
```{r 'B23P0102', echo=FALSE, ref.label=c('B23P01', 'B23P02'), fig.cap="Champo: WSS and Silhouette"}
#
```
...
```{r 'B23P03', echo=FALSE, fig.cap="Champo: k-means with k=3"}
...
```{r 'B23P04', echo=FALSE, fig.cap="Champo: k-means with k=6"}
